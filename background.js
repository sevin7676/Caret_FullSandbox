...
var openWindow = function () {
    ...
    chrome.app.window.create("main_secure.html", {
        bounds: defaults,
        id: "caret:main",
        frame: "none",
        minWidth: 640,
        ...
        mainWindow = win;
        //        win.contentWindow.console.log('hello from background.js');      
        //NOTE: this allows adding function in the main window before onload is fired. This will need to be moved to the sandbox api
